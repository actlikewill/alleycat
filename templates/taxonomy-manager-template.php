<div class="wrap">
    ...
    <ul class="nav nav-tabs">
        <li class="<?php  echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>"><a href="#tab-1">Taxonomy Settings</a></li>
        <li class="<?php  echo isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
            <a href="#tab-2">
                <?php  echo isset($_POST["edit_taxonomy"]) ? 'Edit' : 'Add' ?> Taxonomy Settings 
            </a>
        </li>
    ...
    <div class="tab-content">
        ...
        <div id="tab-1" class="tab-pane   <?php  echo !isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
          ...
          <?php 
				$options = get_option( 'alleycat_plugin_taxonomy' ) ?: array();
				...
				foreach ($options as $option) {
					...
					settings_fields( 'alleycat_plugin_taxonomy_settings' );
        ...
        <div id="tab-2" class="tab-pane <?php  echo isset($_POST["edit_taxonomy"]) ? 'active' : '' ?>">
            ...
            <?php 
                settings_fields('alleycat_plugin_taxonomy_settings');
                do_settings_sections( 'alleycat_taxonomy_manager' );
                submit_button();
            ?>
            </form>
