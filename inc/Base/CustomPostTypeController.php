...
class CustomPostTypeController extends BaseManagerController
{   
	...
	public function setSettings()
    {
      ...
      $option_list = [
        [
          'option_group' => 'alleycat_plugin_cpt_settings',
          'option_name' => 'alleycat_plugin_cpt',
